...
export const updateEquivalencia = async (req, res) => {
  try {
    ...
    const transporter = nodeMailer.createTransport({
      ...
      secure: true,
      auth: {
        user: process.env.NODEMAILER_USER, //'test.unahur@gmail.com',
        pass: process.env.NODEMAILER_PASSWORD, //'fertisgyetkexnja'
      },
      tls: {
    ...
    const emailsList = ['pablo.origlia@gmail.com'];

    const info = await transporter.sendMail({
      from: 'Test UNaHur <test.unahur@gmail.com>',
      to: emailsList,
      subject: 'Hola! Esto es una prueba!',
      html: 'Aplicación de Equivalencias UNaHur',
    });
